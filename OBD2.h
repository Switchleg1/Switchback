...
enum {
  ...
  OXYGEN_SENSOR_1_FUEL_AIR_RATIO                    = 0x34,
  OXYGEN_SENSOR_2_FUEL_AIR_RATIO                    = 0x35,
  OXYGEN_SENSOR_3_FUEL_AIR_RATIO                    = 0x36,
  OXYGEN_SENSOR_4_FUEL_AIR_RATIO                    = 0x37,
  OXYGEN_SENSOR_5_FUEL_AIR_RATIO                    = 0x38,
  OXYGEN_SENSOR_6_FUEL_AIR_RATIO                    = 0x39,
  OXYGEN_SENSOR_7_FUEL_AIR_RATIO                    = 0x3a,
  OXYGEN_SENSOR_8_FUEL_AIR_RATIO                    = 0x3b,
...
#define NUM_PIDS                  10
#define PIDS_BAROMETRIC_PRESSURE  0
#define PIDS_INTAKE_TEMPERATURE   1
#define PIDS_THROTTLE_POSITION    2
#define PIDS_STFT                 3
#define PIDS_LTFT                 4
#define PIDS_TIMING_ADVANCE       5
#define PIDS_SPEED                6
#define PIDS_ENGINE_RPM           7
#define PIDS_AFR                  8
#define PIDS_COOLANT_TEMPERATURE  9

const int PIDS[NUM_PIDS][2] = 
{
  {ABSOLULTE_BAROMETRIC_PRESSURE, 128},
  {AIR_INTAKE_TEMPERATURE, 4},
  {THROTTLE_POSITION, 2},
#ifdef DEBUG_SENSORS
  {INTAKE_MANIFOLD_ABSOLUTE_PRESSURE, 1},
  {FUEL_RAIL_GAUGE_PRESSURE, 1},
#else
  {SHORT_TERM_FUEL_TRIM_BANK_1, 1},
  {LONG_TERM_FUEL_TRIM_BANK_1, 16},
#endif
  {TIMING_ADVANCE, 2},
  {VEHICLE_SPEED, 2},
  {ENGINE_RPM, 1},
  {OXYGEN_SENSOR_1_FUEL_AIR_RATIO, 1},
  {ENGINE_COOLANT_TEMPERATURE, 64}
};
...
extern volatile float PIDValues[NUM_PIDS];
